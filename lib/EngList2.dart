...
import 'Invitation2.dart';

class EngList2 extends StatefulWidget {
  @override
  _EngList2State createState() => _EngList2State();
}

class _EngList2State extends State<EngList2> {
  String selectedFactory = 'Factory 2';
  int selectedIndex = 0;

  List<Map<String, String>> contacts = [
    {'name': 'Alice', 'phone': '+60109876543'},
    {'name': 'Bob', 'phone': '+60111234567'},
    {'name': 'Charlie', 'phone': '+60122345678'},
  ];
